    ...
    <div class="container">
                      ...
                      @foreach($items as $item)
                        ...
                        <tr>
                          ...
                          @if ($item->model->stock_status == 'instock')
                                ...
                                @endif
                                <a href="javascript:void(0)" class="icon" onclick="removeFromishlast('{{$item->rowId}}')">
                                    <i class="fas fa-times"></i>
                                </a>
                            </td>
                        </tr> 
        ...
        <div class="row">
            <div class="col-md-12 text-end">
                <a href="javascript:void(0)" onclick="clearhishlist()">clear all itemes</a>
            </div>
        </div>
        @else
        <div class="row">
            <div class="col-md-12 text-center">
                          <h2>tour wishlist is empye</h2>
                          <h5 class="mt-3">add item to it now</h5>
                          <a href="{{route('shop.index')}}" class="btn btn-warning mt-5">shop New</a>              
            </div>
        </div>
        @endif
    </div>
...
<form type="hidden" name="rowId" id="mrowId" action="">
...
function removeFromishlast(rowId)
$("#rowId").val(rowId);
$("#deleteFromwishlist").submit();
Function clearhishlist()
{
