                    ...
                    <div class="accordion category-name" id="accordionExample">
                                        ...
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" id="br{{$brand->id}}" name="brands" 
                                                 @if(in_array($brand->id ,explode(',', $q_brands)))  @endif value="{{$brand->id}}" type="checkbox"
                                                  onchange="console.log('Checkbox changed!'); filterproductsByCategory(this)">
                        ...
                        <div class="accordion-item category-price">
                            <h2 class="accordion-header" id="headingFour">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    data-bs-tar="#collapseFour">Price</button>
                            </h2>
                    ...
                    <div>
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="{{asset('shop.product.details',['slug'=>$product->slug])}}">
                                ...
                                <div class="cart-wrap">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="javascript:void(0)" onclick ="AddproductroWishlist({{$product->id}},'{{$product->name}}',1,{{$product->regular_price}})" class="wishlist" >
...
$(function(){
    ...
    function filterproductsByCategory(brand){
        ...
        $('#Frmfilter').submit();
              ...
              function AddproductroWishlist(id,name,quantity,Price)
              {
                $.ajax({
                    type:"POST",
                  ...
                  success:function(data){
                        if(data.status == 200)
                        {
                            ...
                            $.notify({
                                icon : "fa fa-check" ,
                                title: "success!" , 
                                message :  "your item add to your website +1"
                            });
                        }
                    }
                });
